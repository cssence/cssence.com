...
const modify = (content, meta) => {
	...
	const footer = [
		...
		`<p>${firstLastLink}<a href="#navigation" accesskey="n">Browse<span aria-hidden="true" data-hl="Menu"></span></a> <a href="#top" accesskey="0">Back to top</a></p>`,
		'</section>',
		'</div>',
		'</footer>'
	];
